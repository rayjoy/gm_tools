...
## [0.2.3] - 2026-01-20
- 新增：**ZUC-256 MAC (完整性校验)** 支持。
    - 基于“ZUC-256 新初始化方案” (128-bit IV)。
    - 支持生成 32-bit、64-bit、128-bit 长度的 MAC (Tag)。
    - UI 新增 ZUC 模式切换（加解密 / MAC生成）及 MAC 长度选择。
    - 通过标准测试向量验证 (TV1, TV2 以及 32/64/128-bit MAC 测试值)。
